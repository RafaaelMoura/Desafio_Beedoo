...
|Título do curso | Descrição do curso	 | Instrutor | Imagem da capa do livro	|
...
Cenário 3: Exibir mensagem de vagas esgotadas quando não houver mais vagas - Falha
 ...
 - Então devo ver uma mensagem alertando "Vagas esgotadas"
